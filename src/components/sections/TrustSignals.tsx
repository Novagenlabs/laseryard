        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...logos, ...logos, ...logos].map((logo, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-32 h-12 rounded-lg bg-card/50 border border-border/50 flex items-center justify-center transition-all duration-300 hover:border-gold/30 hover:bg-card group"
              >
